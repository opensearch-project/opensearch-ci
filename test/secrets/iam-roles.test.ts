...
test('IAM Roles Stack Resources', () => {
  ...
  template.resourceCountIs('AWS::IAM::Role', 103);
  template.resourceCountIs('AWS::IAM::Policy', 103);
      ...
      Statement: [
        {
          ...
          Resource: [
            ...
            'arn:aws:bedrock:*:test-account:inference-profile/us.anthropic.claude-opus-4-7',
            'arn:aws:bedrock:*:test-account:inference-profile/us.anthropic.claude-opus-4-8',
