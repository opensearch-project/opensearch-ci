...
jdk_versions=(
    ...
    "11@https://github.com/adoptium/temurin11-binaries/releases/download/jdk-11.0.23%2B9/OpenJDK11U-jdk_x64_mac_hotspot_11.0.23_9.tar.gz@100"
...
if [ "$ARCH" = "arm64" ]; then
    ...
    jdk_versions=(
        ...
        "11@https://github.com/adoptium/temurin11-binaries/releases/download/jdk-11.0.23%2B9/OpenJDK11U-jdk_aarch64_mac_hotspot_11.0.23_9.tar.gz@100"
...
for version_info in "${jdk_versions[@]}"; do
    ...
    $BREW_PATH/wget "$version_url" -O "openjdk-${version_num}.tar.gz"
...
$BREW_PATH/wget https://github.com/macports/macports-base/releases/download/v2.9.3/MacPorts-2.9.3.tar.gz
...
$BREW_PATH/wget https://bootstrap.pypa.io/get-pip.py
python3 get-pip.py
